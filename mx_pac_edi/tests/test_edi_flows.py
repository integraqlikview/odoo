...
class TestEdiFlows(TestMxEdiCommon):
    ...
    def test_invoice_flow_not_sent(self):
        with freeze_time(self.frozen_today):
            ...
            document = self.invoice.edi_document_ids.filtered(lambda d: d.edi_format_id == self.env.ref('mx_pac_edi.edi_cfdi_3_3'))
    ...
    def test_payment_flow_PUE_invoice(self):
        with freeze_time(self.frozen_today):
            ...
            self.payment.action_mx_pac_edi_force_generate_cfdi()

            document = self.payment.edi_document_ids.filtered(lambda d: d.edi_format_id == self.env.ref('mx_pac_edi.edi_cfdi_3_3'))
    ...
    def test_statement_flow_PUE_invoice(self):
        with freeze_time(self.frozen_today):
            ...
            self.statement_line.action_mx_pac_edi_force_generate_cfdi()

            document = self.statement_line.edi_document_ids.filtered(lambda d: d.edi_format_id == self.env.ref('mx_pac_edi.edi_cfdi_3_3'))
