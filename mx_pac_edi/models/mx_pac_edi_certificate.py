...
try:
    ...
    _logger.warning('OpenSSL library not found. If you plan to use mx_pac_edi, please install the library from https://pypi.python.org/pypi/pyOpenSSL')
...
class Certificate(models.Model):
    ...
    def unlink(self):
        mx_edi = self.env.ref('mx_pac_edi.edi_cfdi_3_3')
